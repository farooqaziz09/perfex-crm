...
function perfex_saas_handle_tenant_404_static_file_request($tenant, $upload_folder, $tenants_upload_folder)
{
    ...
    $url = perfex_saas_url_origin($_SERVER, true, true); // full url with query
