...
<div class="tw-flex tw-flex-col">
    ...
    <input name="settings[<?= $key; ?>][]" value="" type="hidden" />
    <div class="form-group select-placeholder clientid reversed-list">
        <label for="clientid" class="control-label"><?php echo _l($key); ?></label>
        <select id="clientid" name="settings[<?= $key; ?>][]" data-live-search="true" data-width="100%" multiple="true"
            class="ajax-search selectpicker" data-selected="<?= strip_quotes(json_encode($value)); ?>"
