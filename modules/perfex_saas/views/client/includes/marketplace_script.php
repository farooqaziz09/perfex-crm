...
(() => {
    ...
    addButtons.forEach((button, index) => {
        button.addEventListener('click', (e) => {
            ...
            const oneTimeTag =
                '<span data-toggle="tooltip" data-title="<?= e(_l('perfex_saas_service_one_time_payment_hint')); ?>" class="badge bg-warning tw-px-1"><?= e(_l('perfex_saas_service_one_time_payment')); ?></span>';
