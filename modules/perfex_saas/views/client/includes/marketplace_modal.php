            ...
            <div class="modal-body">
                <div class="row saas-market-items">
                    ...
                    <?php
                        ...
                        if ((empty($item['price']) && empty($package->metadata->limitations_unit_price->{$item_id}))) continue;

                        $price = $package->metadata->limitations_unit_price->{$item_id} ?? $item['price'];
                            ...
                            <div class="card-body">
                                ...
                                <div class="tw-flex tw-justify-end">
                                    ...
                                    <small class="btn btn-secondary disabled btn-sm" data-toggle="tooltip"
                                        data-title="<?= e(_l('perfex_saas_module_included_hint')); ?>"
                                    ...
                                    <button type="button"
                                        ...
                                        data-confirm="<?= e(_l('perfex_saas_service_one_time_payment_hint')); ?>"
