...
<div class="row">
    <div class="col-md-12">
        <h4
            class="company-view-heading tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700 tw-flex tw-items-center tw-space-x-2">
            ...
            <div class="panel-body">
                ...
                <div class="alert alert-warning text-center">
                    ...
                    <div class="tw-flex tw-mt-4 tw-w-full">
                        ...
                        <textarea name="extra_note" class="form-control" cols="2" rows="2"
                            placeholder="<?= _l('perfex_saas_extra_email_note'); ?>"></textarea>
                        <div class="text-left tw-flex tw-justify-between tw-w-full">
                            <input name="cancel" type="submit" data-loading-text="<?= _l('perfex_saas_saving...'); ?>"
                                ...
                                onclick="return confirm('<?= _l('perfex_saas_confirm_action', _l('perfex_saas_cancel')); ?>');" />
                            <input name="approve" type="submit" data-loading-text="<?= _l('perfex_saas_saving...'); ?>"
                                ...
                                onclick="return confirm('<?= _l('perfex_saas_confirm_action', _l('perfex_saas_approve')); ?>');" />
                        </div>
                        <?php echo form_close(); ?>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="form-control-static tw-flex tw-flex-col">
                        ...
                        <span class="tw-mb-2 tw-flex tw-flex-col">
                            <a href="<?= $value; ?>" target="_blank" data-toggle="tooltip"
                                data-title="<?= _l('perfex_saas_customer_link'); ?>"><?= $value; ?></a>
                            <a href="<?= $value . 'admin'; ?>" target="_blank" data-toggle="tooltip"
                                data-title="<?= _l('perfex_saas_admin_link'); ?>"><?= $value . 'admin'; ?></a>
                        </span>
                        <?php endforeach; ?>
                    </p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p class="form-control-static">
                        <?php
                            ...
                            echo $dsn_string;
                            ?>
                        <button class="btn btn-xs btn-primary btn-circle rounded tw-ml-2" data-toggle="modal"
                            data-target="#dsn_modal"><i class="fa fa-edit"
                                title="<?= _l('perfex_saas_update_datacenter'); ?>" data-toggle="tooltip"></i></button>
                    </p>
                </div>
                <?php endif; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary update-datacenter"
                    onclick="saasUpdateDatacenter()"><?= _l('perfex_saas_update_datacenter'); ?></button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
